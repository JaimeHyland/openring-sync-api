...
```text
[127.0.0.1](http://127.0.0.1:8000/api/docs/)
```
The raw OpenAPI schema is available at:
```text
[127.0.0.1](http://127.0.0.1:8000/api/schema/)
```
## Local setup
...
After accessing 
```text
[127.0.0.1](http://127.0.0.1:8000/admin/)
```
you may see a login dialog. Enter the superuser name and password you gave when creating your superuser and you will be given access to Django's rather excellent admin screens, in which you can explore the contents of your database.
...
If you have any questions about getting this prototype running, please do not hesitate to contact me.
